...
import 'package:mongo_db_driver/src/gridfs/chunk_handler.dart';
import 'package:mongo_db_driver/src/gridfs/grid_in.dart';
...
void clearFSCollections(GridFS gridFS) {
  gridFS.files.deleteMany();
  gridFS.chunks.deleteMany();
}
...
Future<List<CountResult>> getInitialState(GridFS gridFS) async {
  var futures = <Future<CountResult>>[];
