...
class ClientSession {
  ...
  // ************   TRANSACTIONS   **********************
  bool get inTransaction => transaction.isActive;
  // TODO check the case load balanced
  bool get isPinned => transaction.isPinned;
  bool get isTransactionCommitted => transaction.isCommitted;
  ...
  Future<MongoDocument?> abortTransaction(
    ...
    TransactionState txnState = transaction.state;
    ...
    MongoDocument ret = await command.process();
    transaction.state = TransactionState.aborted;
    return ret;
  }
